...
type LoginWithJWTTokenRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	JwtToken      string                 `protobuf:"bytes,1,opt,name=jwtToken,proto3" json:"jwtToken,omitempty"`
	Hostname      string                 `protobuf:"bytes,2,opt,name=hostname,proto3" json:"hostname,omitempty"`
	ProfileName   *string                `protobuf:"bytes,3,opt,name=profileName,proto3,oneof" json:"profileName,omitempty"`
	...
	AdminURL      string                 `protobuf:"bytes,6,opt,name=adminURL,proto3" json:"adminURL,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *LoginWithJWTTokenRequest) Reset() {
	*x = LoginWithJWTTokenRequest{}
	mi := &file_daemon_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LoginWithJWTTokenRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginWithJWTTokenRequest) ProtoMessage() {}

func (x *LoginWithJWTTokenRequest) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginWithJWTTokenRequest.ProtoReflect.Descriptor instead.
func (*LoginWithJWTTokenRequest) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{5}
}

func (x *LoginWithJWTTokenRequest) GetJwtToken() string {
	if x != nil {
		return x.JwtToken
	}
	return ""
...
func (x *LoginWithJWTTokenRequest) GetHostname() string {
	if x != nil {
		return x.Hostname
	}
	return ""
...
func (x *LoginWithJWTTokenRequest) GetProfileName() string {
	if x != nil && x.ProfileName != nil {
		return *x.ProfileName
	}
	return ""
...
func (x *LoginWithJWTTokenRequest) GetUsername() string {
	if x != nil && x.Username != nil {
		return *x.Username
	}
	return ""
...
func (x *LoginWithJWTTokenRequest) GetManagementUrl() string {
	if x != nil {
		return x.ManagementUrl
	}
	return ""
...
func (x *LoginWithJWTTokenRequest) GetAdminURL() string {
	if x != nil {
		return x.AdminURL
	}
	return ""
...
const file_daemon_proto_rawDesc = "" +
	...
	"\x17verificationURIComplete\x18\x04 \x01(\tR\x17verificationURIComplete\"\xf9\x01\n" +
	"\x18LoginWithJWTTokenRequest\x12\x1a\n" +
	"\bjwtToken\x18\x01 \x01(\tR\bjwtToken\x12\x1a\n" +
	"\bhostname\x18\x02 \x01(\tR\bhostname\x12%\n" +
	"\vprofileName\x18\x03 \x01(\tH\x00R\vprofileName\x88\x01\x01\x12\x1f\n" +
	"\busername\x18\x04 \x01(\tH\x01R\busername\x88\x01\x01\x12$\n" +
	"\rmanagementUrl\x18\x05 \x01(\tR\rmanagementUrl\x12\x1a\n" +
	"\badminURL\x18\x06 \x01(\tR\badminURLB\x0e\n" +
	"\f_profileNameB\v\n" +
	"\t_username\"M\n" +
	...
	"\rDaemonService\x126\n" +
	"\x05Login\x12\x14.daemon.LoginRequest\x1a\x15.daemon.LoginResponse\"\x00\x12N\n" +
	"\x11LoginWithJWTToken\x12 .daemon.LoginWithJWTTokenRequest\x1a\x15.daemon.LoginResponse\"\x00\x12K\n" +
...
var file_daemon_proto_goTypes = []any{
	...
	(*LoginWithJWTTokenRequest)(nil),           // 10: daemon.LoginWithJWTTokenRequest
...
var file_daemon_proto_depIdxs = []int32{
	...
	96,  // 16: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	97,  // 17: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	...
	100, // 28: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	98,  // 29: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	59,  // 30: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	99,  // 31: daemon.SetConfigRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	...
	34,  // 35: daemon.Network.ResolvedIPsEntry.value:type_name -> daemon.IPList
	8,   // 36: daemon.DaemonService.Login:input_type -> daemon.LoginRequest
	10,  // 37: daemon.DaemonService.LoginWithJWTToken:input_type -> daemon.LoginWithJWTTokenRequest
	...
	9,   // 75: daemon.DaemonService.LoginWithJWTToken:output_type -> daemon.LoginResponse
	12,  // 76: daemon.DaemonService.WaitSSOLogin:output_type -> daemon.WaitSSOLoginResponse
	14,  // 77: daemon.DaemonService.Up:output_type -> daemon.UpResponse
	16,  // 78: daemon.DaemonService.Status:output_type -> daemon.StatusResponse
	18,  // 79: daemon.DaemonService.Down:output_type -> daemon.DownResponse
	20,  // 80: daemon.DaemonService.GetConfig:output_type -> daemon.GetConfigResponse
	31,  // 81: daemon.DaemonService.ListNetworks:output_type -> daemon.ListNetworksResponse
	33,  // 82: daemon.DaemonService.SelectNetworks:output_type -> daemon.SelectNetworksResponse
	33,  // 83: daemon.DaemonService.DeselectNetworks:output_type -> daemon.SelectNetworksResponse
	38,  // 84: daemon.DaemonService.ForwardingRules:output_type -> daemon.ForwardingRulesResponse
	40,  // 85: daemon.DaemonService.DebugBundle:output_type -> daemon.DebugBundleResponse
	42,  // 86: daemon.DaemonService.GetLogLevel:output_type -> daemon.GetLogLevelResponse
	44,  // 87: daemon.DaemonService.SetLogLevel:output_type -> daemon.SetLogLevelResponse
	47,  // 88: daemon.DaemonService.ListStates:output_type -> daemon.ListStatesResponse
	49,  // 89: daemon.DaemonService.CleanState:output_type -> daemon.CleanStateResponse
	51,  // 90: daemon.DaemonService.DeleteState:output_type -> daemon.DeleteStateResponse
	53,  // 91: daemon.DaemonService.SetSyncResponsePersistence:output_type -> daemon.SetSyncResponsePersistenceResponse
	57,  // 92: daemon.DaemonService.TracePacket:output_type -> daemon.TracePacketResponse
	59,  // 93: daemon.DaemonService.SubscribeEvents:output_type -> daemon.SystemEvent
	61,  // 94: daemon.DaemonService.GetEvents:output_type -> daemon.GetEventsResponse
	63,  // 95: daemon.DaemonService.SwitchProfile:output_type -> daemon.SwitchProfileResponse
	65,  // 96: daemon.DaemonService.SetConfig:output_type -> daemon.SetConfigResponse
	67,  // 97: daemon.DaemonService.AddProfile:output_type -> daemon.AddProfileResponse
	69,  // 98: daemon.DaemonService.RemoveProfile:output_type -> daemon.RemoveProfileResponse
	71,  // 99: daemon.DaemonService.ListProfiles:output_type -> daemon.ListProfilesResponse
	74,  // 100: daemon.DaemonService.GetActiveProfile:output_type -> daemon.GetActiveProfileResponse
	76,  // 101: daemon.DaemonService.Logout:output_type -> daemon.LogoutResponse
	78,  // 102: daemon.DaemonService.GetFeatures:output_type -> daemon.GetFeaturesResponse
	80,  // 103: daemon.DaemonService.TriggerUpdate:output_type -> daemon.TriggerUpdateResponse
	82,  // 104: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	84,  // 105: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	86,  // 106: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
	88,  // 107: daemon.DaemonService.StartCPUProfile:output_type -> daemon.StartCPUProfileResponse
	90,  // 108: daemon.DaemonService.StopCPUProfile:output_type -> daemon.StopCPUProfileResponse
	7,   // 109: daemon.DaemonService.NotifyOSLifecycle:output_type -> daemon.OSLifecycleResponse
	92,  // 110: daemon.DaemonService.GetInstallerResult:output_type -> daemon.InstallerResultResponse
	94,  // 111: daemon.DaemonService.ExposeService:output_type -> daemon.ExposeServiceEvent
